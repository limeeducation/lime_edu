...
<div class="sidebar pe-4 pb-3">
	...
	<nav class="navbar bg-secondary navbar-dark">
		<a href="/admin/main" class="navbar-brand mx-4 mb-3">
			<h3 class="text-success"><i class="fa fa-user-edit me-2"></i>LIME EDU</h3>
		</a>
		...
		<div class="navbar-nav w-100">
			<a href="/admin/main" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
