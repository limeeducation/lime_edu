...
<div class="quick_nav">
	...
	<ul class="quick_list">
		...
		<div id="kakao-talk-channel-chat-button"  class="kakao_chat" data-channel-public-id="_mnYdxj" data-title="consult" data-size="large" data-color="yellow" data-shape="mobile" data-support-multiple-densities="true" style="margin-top:1.2rem;"></div>
	</ul>
	<ul class="quick_time">
