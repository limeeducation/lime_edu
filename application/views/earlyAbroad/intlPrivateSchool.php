					...
					<div class="bg_green">
						<div class="sec_about_academy cotn">
							...
							<div class="cotn_box type2">
								<p>
									아이 온타리오 주 교육부의 정식 고등학교로 허가를 받아 설립된 고등학교 학점(크레딧)을 이수해서 <br />
									캐나다 고졸 학력을 취득할 수 있는 사립학교를 말합니다.
								</p>
								<p>
									온타리오 고등학교 졸업장 OSSD(Ontario Secondary School Diploma)를 취득학기 위한 9~12학년의 다양한 정규 고등학교 과목들, <br />
									IELTS 시험준비과정, 그리고 예술계열 대학 입시에서 필요한 포트폴리오 준비과정 등을 제공하고
								</p>
							</div>
