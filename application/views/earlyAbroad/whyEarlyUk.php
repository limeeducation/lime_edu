...
?>
<link rel="stylesheet" type="text/css" href="/static/css/pre_uk.css">
			...
			<div id="content">
				...
				<div id="detail_wrap">
					...
					<div class="sec_01">
						<div class="cotn">
							<div class="tit_area">
								<h2 class="tit">왜 영국 조기유학을<br>선택해야 하나요?</h2>
							</div>
							<div class="reason_li">
								<div class="in_wrap">
									<div class="list">
										<span class="num">01</span>
										<p class="txt">우수한 영국 교육 수준</p>
									</div>
								</div>
								<div class="in_wrap">
									<div class="list">
										<span class="num">02</span>
										<p class="txt">안전한 교육 환경</p>
									</div>
								</div>
								<div class="in_wrap">
									<div class="list">
										<span class="num">03</span>
										<p class="txt">세계 최고의 엘리트 양성교육</p>
									</div>
								</div>
								<div class="in_wrap">
									<div class="list">
										<span class="num">04</span>
										<p class="txt">심화교육 줌점의 중등 교육과정 GCSE</p>
									</div>
								</div>
								<div class="in_wrap">
									<div class="list">
										<span class="num">05</span>
										<p class="txt">미래형 인재 양성 교육법</p>
									</div>
								</div>
							</div>
						</div>
